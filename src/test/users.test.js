...
const mutationRegister= `
    mutation Register($first_name:String! $last_name:String!,$email:String!,$password:String!){
        signup(data:{first_name:$first_name,last_name:$last_name,email:$email,password:$password
        }){
            token
        }
    }
...
describe("Register user works correctly", () =>{
    ...
    it("Should create user correctly", async ()=> {
        ...
        const res= await graphql(schema,mutationRegister,null,{},{first_name,last_name,email,password})
